...
import { e as createError$1, n as hasProtocol, q as isScriptProtocol, p as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, y as createHooks, z as executeAsync, A as toRouteMatcher, B as createRouter$1, C as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DPi8ZmMM.mjs')
  },
  {
    name: "blog-new",
    path: "/blog/new",
    component: () => import('./new-BUgptV6s.mjs')
  },
  {
    name: "blog-id",
    path: "/blog/:id()",
    component: () => import('./_id_-Do6XA686.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-Dj-Sl1_6.mjs')
  },
  {
    name: "blog-view-id",
    path: "/blog/view/:id()",
    component: () => import('./_id_-y0X-Ww8Q.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BbEbeanh.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-TgN1JDuW.mjs'));
...
export { asyncDataDefaults as a, useRouter as b, createError as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, fetchDefaults as f, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
